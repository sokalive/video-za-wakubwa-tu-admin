...
export function StatsGrid({ stats }: StatsGridProps) {
  const cards: StatCardProps[] = [
    ...
    { title: "Total Categories", value: formatNumber(stats.totalCategories), icon: FolderOpen, gradient: "bg-gradient-to-br from-cyan-600 to-cyan-700" },
    { title: "Total Users", value: formatNumber(stats.totalUsers), icon: Users, gradient: "bg-gradient-to-br from-yellow-600 to-orange-600" },
