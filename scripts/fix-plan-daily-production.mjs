...
const fix = await fetch(`${admin}/api/vip-plans/plan-daily`, {
  method: "PUT",
  headers: { "Content-Type": "application/json", Cookie: cookie },
  body: JSON.stringify({ name: "3 Day", durationValue: 3, durationUnit: "days", type: "daily" }),
});
console.log(JSON.stringify({ status: fix.status, body: await fix.json() }, null, 2));
